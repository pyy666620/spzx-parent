...
public interface SkuStockMapper extends BaseMapper<SkuStock> {
    ...
    Integer checkAndSubStock(@Param("skuId") Long skuId,@Param("skuNum") Integer skuNum);

    Integer addStockAndSubSaleNum(@Param("skuId") Long skuId, @Param("skuNum") Integer skuNum);
}